		...
		<div id="principal">
			...
			<form action="postCadastraDepartamento" method="POST">
				<div class="row">
					...
					<div class="col-md-6">
						<div class="form-group">
							<label for="nome">Sigla:<span class="requerido">*</span></label>
							<input type="text" name="sigla" class="form-control" id="nome" value="<?php if(isset($_SESSION["flash"]["nome"]))echo $_SESSION["flash"]["nome"];?>" required>
						</div>					
					</div>
			  	</div>
